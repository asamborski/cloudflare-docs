...
Infrastructure applications use a PIV key authenticator (`infrastructure_ssh`) that is specific to SSH connections. This authenticator type is not available for other Access application types.
